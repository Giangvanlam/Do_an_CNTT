...
Route::middleware(['setlang'])->group(function () {
    ...
    Route::get('/home', 'Front\FrontendController@index')->name('front.index');
    ...
    Route::get('/payreturn/success/{order_id?}', 'Payment\product\PaymentCODController@payreturn')->name('front.payreturn.success');
    // Product
