                                ...
                                <div class="">
                                    <div class="shop-review-title">
                                        ...
                                        <div class="shop-review-user">
                                            ...
                                            <span>
                                                <span>
                                                @if (isset($review->user) && !empty(convertUtf8($review->user->username))) {{ convertUtf8($review->user->username) }} @elseif(isset($review->user->number)) {{ convertUtf8($review->user->number) }}  @endif</span>
