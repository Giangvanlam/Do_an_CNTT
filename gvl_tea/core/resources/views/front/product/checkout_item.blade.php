...
<link href="{{ asset('assets/front/select2/css/select2.min.css') }}" rel="stylesheet" />
                            ...
                            <div id="accordion" class="accordion_area">
                                ...
                                {{-- @if ($paypal->status == 1) --}}
                                    ...
                                    <div class="option-block">
                                        <div class="radio-block">
                                            <div class="checkbox" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                <input name="method" type="radio" class="delivery-check" value="vnpay">
                                                <a class="collapsed">
                                                    <span>{{__('Thanh Toán Qua Vnpay ')}}</span>
                                                </a> <br>
                                                <div id="vnpay" class="collapse show" aria-labelledby="vnpay" data-parent="#vnpay">
                                                    <div class="card-body">
                                                        Thanh toán qua ví điện tử vnpay của cửa hàng
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script src="{{ asset('assets/front/select2/js/select2.min.js') }}"></script>
