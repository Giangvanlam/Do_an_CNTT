...
@section('content')
    ...
    <div class="container-slider" style="min-height: 500px;">
        <div class="banner-slide">
            @foreach ($sliders as $slider)
            <div class="banner-area bg_cover d-flex align-items-center" style="background-image: url({{$slider->bg_image ? asset('assets/front/img/sliders/bg_image/'.$slider->bg_image) : ''}}); min-height: 500px;">
                <div class="container">
                    <div class="row">
