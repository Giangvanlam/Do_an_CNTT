                      ...
                      <tr>
                         ...
                         <td>
                            <form id="statusForm{{$order->id}}" class="d-inline-block" action="{{route('admin.product.orders.status')}}" method="post">
                               ...
                               <option value="pending|Pending" {{$order->order_status == 'pending' ? 'selected' : ''}}>Pending</option>
                               <option value="processing|Completed" {{$order->order_status == 'processing' ? 'selected' : ''}}>Processing</option>
                               <option value="processing|Pending" {{$order->order_status == 'completed' ? 'selected' : ''}}>Completed</option>
                               <option value="rejected|Pending" {{$order->order_status == 'reject' ? 'selected' : ''}}>Rejected</option>
                               </select>
                            </form>
                         </td>
                         <td>
